        ...
        <div id="hdr-top-wrapper">
            <div class="layer-stretch hdr-top">
                ...
                <div class="hdr-top-block hdr-number">
                    <div class="font-13">
                        <i class="fa fa-mobile font-20 tbl-cell"> </i> <span class="hidden-xs tbl-cell"> Comuníquese : </span> <span class="tbl-cell">123456789</span>
                    </div>
                </div>
                ...
                <div class="tbl">
                    <div class="tbl-row">
                        ...
                        <div class="tbl-cell hdr-logo">
                            <a href="index.html"><img src="plantilla/images/logo.png" alt=""></a>
                            ...
                            <ul class="menu">
                               ...
                               <!-- <li>
                                  ...
                                  <li>
                                    ...
                                    <ul class="menu-dropdown">
                                        <li>
                                            <a href="regionapurimac.gob.pe">Gobierno Regional de Apurímac</a>
                                            <ul class="menu-dropdown">
                                    ...
                                    <ul class="menu-megamenu">
                                        <li class="row">
                                            <div class="col-lg-4">
                                                <div class="megamenu-ttl">RESCA</div>
                                                <ul>
                                                    <li><a href="event-1.html">Certificación Ambiental</a></li>
                                                    <li><a href="event-2.html">Ventanilla Única</a></li>
                                                    <li><a href="event-3.html">Resultados de Evaluación Ambiental</a></li>
                                                    <li><a href="faq.html">Pautas de Orientación</a></li>   
                                                </ul>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="megamenu-ttl">DOCUMENTOS</div>
                                                <ul>
                                                    <li><a href="doctors-5.html">TUPA</a></li>
                                                    <li><a href="doctors-6.html">MAPRO</a></li>
        ...
        <div class="layer-stretch">
            <div class="layer-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <img class="img-thumbnail" src="plantilla/uploads/hm-about.jpg" alt="">
                    </div>
        ...
        <div class="layer-wrapper layer-bottom-10">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <div class="hm-feature-block-1">
                        <div class="theme-img theme-img-scalerotate">
                            <img src="plantilla/uploads/feature-1.jpg" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="hm-feature-block-1">
                        <div class="theme-img theme-img-scalerotate">
                            <img src="plantilla/uploads/feature-2.jpg" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="hm-feature-block-1">
                        <div class="theme-img theme-img-scalerotate">
                            <img src="plantilla/uploads/feature-3.jpg" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="hm-feature-block-1">
                        <div class="theme-img theme-img-scalerotate">
                            <img src="plantilla/uploads/feature-4.jpg" alt="">
                        </div>
                        <span>Ambulance</span>
                        <p class="paragraph-small paragraph-black">Mel in hinc veri admodum, copiosae epicurei mea ei. Cum at nisl soleat. Eam insolens referrentur efficiantur an. Nibh deleniti ad vix, quodsi aliquam legendos pri in.</p>
                    </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="hm-feature-block-1">
                        <div class="theme-img theme-img-scalerotate">
                            <img src="plantilla/uploads/feature-5.jpg" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="hm-feature-block-1">
                        <div class="theme-img theme-img-scalerotate">
                            <img src="plantilla/uploads/feature-6.jpg" alt="">
                        </div>
            ...
            <div class="layer-wrapper">
                ...
                <div class="layer-container">
                    <div id="hm-doctor-slider" class="owl-carousel owl-theme theme-owl-dot">
                        ...
                        <div class="hm-doctor">
                            <img class="img-responsive" src="plantilla/uploads/slide-doctor-5.jpg" alt="">
                            <h6>Barbara Baker</h6>
                            <p>Surgeon</p>
                        </div>
                        <div class="hm-doctor">
                            <img class="img-responsive" src="plantilla/uploads/slide-doctor-6.jpg" alt="">
                            <h6>Linda Adams</h6>
                            <p>Gynocologist</p>
                        </div>
                        <div class="hm-doctor">
                            <img class="img-responsive" src="plantilla/uploads/slide-doctor-7.jpg" alt="">
                            <h6>Emily Rasberry</h6>
                            <p>Pathologist</p>
                        </div>
                        <div class="hm-doctor">
                            <img class="img-responsive" src="plantilla/uploads/slide-doctor-8.jpg" alt="">
                            <h6>Nancy Allen</h6>
                            <p>Gynocologist</p>
                        </div>
                    </div>
                ...
                <div class="layer-container">
                    <div id="testimonial-slider" class="owl-carousel owl-theme theme-owl-dot">
                        <div class="testimonial-block">
                            <img class="img-responsive" src="plantilla/uploads/testimonial-1.jpg" alt="">
                        ...
                        <div class="testimonial-block">
                            <img class="img-responsive" src="plantilla/uploads/testimonial-2.jpg" alt="">
                            <div class="paragraph-medium paragraph-white">
                                <i class="fa fa-quote-left"></i>
                        ...
                        <div class="testimonial-block">
                            <img class="img-responsive" src="plantilla/uploads/testimonial-3.jpg" alt="">
                            <div class="paragraph-medium paragraph-white">
                                <i class="fa fa-quote-left"></i>
                                Thank you for the remedy. I feel it has been working on a deeper subtle level. An inner seeing. I have had the feeling of a melting inside and great sense of peace and rightness. I experienced this before with your perception and treatment so thank you very much.
                            </div>
                        ...
                        <div class="testimonial-block">
                            <img class="img-responsive" src="plantilla/uploads/testimonial-4.jpg" alt="">
                            <div class="paragraph-medium paragraph-white">
                                <i class="fa fa-quote-left"></i>
                        ...
                        <div class="testimonial-block">
                            <img class="img-responsive" src="plantilla/uploads/testimonial-5.jpg" alt="">
                            <div class="paragraph-medium paragraph-white">
                                <i class="fa fa-quote-left"></i>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias corporis ad veniam, illo expedita aut quaerat voluptatem, magni voluptas necessitatibus omnis error quia deserunt asperiores beatae fugiat quisquam magnam mollitia!
                            </div>
