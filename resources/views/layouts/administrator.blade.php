    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- MENSAJE DE NUEVA OBSERVACION  O LEVANTAMIENTO DE OBSERVACION -->
          <li id="mensaje" name="mensaje" class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-envelope-o"></i>
              <span class="label label-success">.</span>
            </a>
          </li>
          <!-- BANDERITA DE PORCENTAJE DE REGISTRO AMBIENTAL -->
          <li id="porcentaje" name="porcentaje" class="dropdown tasks-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="fa fa-flag-o"></i>
              <span class="label label-danger">.</span>
            </a>
          </li>
          <!-- CAMPANITA DE DE NUMERO DE ESTUDIOS -->
           <li id="alerta" name="alerta" class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
     ...
     <!--  <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="@yield('actmenu2')">
          ...
          <a href="#"><i class="fa fa-files-o"></i><span>Evaluación de Registro Ambiental</span>@endcan
          <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
          </a>
          <ul class="treeview-menu">
            @can('admin.evaluacion.index')
