...
<div class="row">
  ...
  <div class="box box-primary">
    ...
    <h3 class="box-tittle">Registrar Opinión Técnica: </h3>
    @if(count($errors)>0)
      ...
      <input type="hidden" id="idproyecto" name="idproyecto" class="form-control" value="{{$idproyecto}}" >
        ...
        <div class="col-md-12">
           <div class="form-group">
            <button type="submit" class="btn btn-success btn-block margin-bottom">Guardar Opinión Técnica</button>
          </div>
        </div>
        <div class="col-md-12">
        <div class="form-group">
          <input class="form-control" id="asuntoobservacion" name="asuntoobservacion" placeholder="Asunto:" value="OPINIÓN TÉCNICA">
        </div>
        </div>
        <div class="col-md-12"> 
        <div class="form-group">
