     ...
     if($request){
        ...
        foreach($usuarios as $us){
         ...
         if($rol=='1'){
            ...
            ->select('e.idestudio','e.nombreestudio','e.descripcionestudio','p.nombreproyecto as proyecto','en.nombreentidad as entidad', 'est.nombreestado as estado','es.created_at as fecha')
