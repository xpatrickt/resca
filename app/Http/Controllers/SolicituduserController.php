     ...
     if($request){
        ...
        foreach($usuarios as $us){
         ...
         if($rol=='1'){
            ...
            ->select('e.idestudio','te.nombretipoestudio','e.nombreestudio','ts.nombretiposolicitud','e.codigosige','e.descripcionestudio','p.nombreproyecto as proyecto','en.nombreentidad as entidad', 'est.nombreestado as estado','es.created_at as fecha')
